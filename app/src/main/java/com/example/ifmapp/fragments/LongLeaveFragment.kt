...
import com.example.ifmapp.databinding.FragmentLongLeaveBinding
...
class LongLeaveFragment : Fragment(), CommonCalendarUtils.CalendarUpdateCallback  {
    private lateinit var binding: FragmentLongLeaveBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_long_leave, container, false)
