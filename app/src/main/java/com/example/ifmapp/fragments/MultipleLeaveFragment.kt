...
import com.example.ifmapp.databinding.FragmentMultipleLeaveBinding
...
class MultipleLeaveFragment : Fragment(), CommonCalendarUtils.CalendarUpdateCallback {
    private lateinit var binding :FragmentMultipleLeaveBinding
    ...
    override fun onCreateView(
        ...
        binding =  DataBindingUtil.inflate(inflater,R.layout.fragment_multiple_leave, container, false)
